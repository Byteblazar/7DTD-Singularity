...
{
	public static void Prefix_Cleanup()
	{
		GamePrefs.Set(EnumGamePrefs.AllowSpawnNearBackpack, true); //In case Singularity is uninstalled
		//GamePrefs.Instance.Save();	//Vanilla saves afterwards anyway
	}
}
