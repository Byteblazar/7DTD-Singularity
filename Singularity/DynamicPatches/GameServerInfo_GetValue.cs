...
public abstract partial class GameServerInfo_Patches
{
	public static void Postfix_GetValue(ref GameInfoBool _key, ref bool __result)
	{
		if (_key == GameInfoBool.AllowSpawnNearBackpack) __result = false;
	}
}
